...
export default function GroupedGenericComponentNotTouchable({leadingIcon, leadingLabel, trailingLabel, trailingItem, separator}: GroupedGenericComponentNotTouchableProps) {
